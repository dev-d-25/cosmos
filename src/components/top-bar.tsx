...
export type TopBarSyncedState = SyncedState;
...
export function TopBar({
  ...
  const profile = profileProp ?? profileQuery.data ?? null;

  const activePath = pathname.startsWith("/mail")
    ? "mail"
      ...
      <div className="flex gap-0.5 text-xs font-medium">
        <Link
          ...
          className={buttonVariants({
            variant: activePath === "mail" ? "secondary" : "ghost",
            size: "sm",
          })}
        >
          Mail
        ...
        <Link
          href="/calendar"
          className={buttonVariants({
            variant: activePath === "calendar" ? "secondary" : "ghost",
            size: "sm",
          })}
        >
          Calendar
        ...
        <Link
          href="/agent"
          className={buttonVariants({
            variant: activePath === "agent" ? "secondary" : "ghost",
            size: "sm",
          })}
        >
          Agent
